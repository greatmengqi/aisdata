...
function AisDecode(input) {
    ...
    if (nmea [0] != '!AIVDM' && nmea [0] != '!ABVDM' && nmea [0] != '!ABVDO') return;
    ...
    if (nmea[1] !== '1') { // ignore multipart extention messages
        this.isOneTime=false;
        this.moreParseData=input;
        this.valid = true;
        return;
    }
    ...
    switch (this.aistype) {
        ...
        case 3: // class A position report
            ...
            this.sog = this.GetInt(50, 10); //speed over ground
            this.cog = this.GetInt(116, 12);  //course over ground
            this.hdg = this.GetInt(128, 9);        //magnetic heading
...
//          2-3 = station compliant with future editions
            ...
            if (AIS_version_indicator <= 2) {
                ...
                this.eta = this.GetInt(274, 20);
                this.draught = this.GetInt(294, 8);
        ...
        case 18: // class B position report
            this.class = 'B';
            this.navstatus = -1;  // Class B targets have no status.  Enforce this...
            ...
            this.sog = this.GetInt(46, 10); //speed over ground
            this.cog = this.GetInt(112, 12); //course over ground
            this.hdg = this.GetInt(124, 9);       //magnetic heading
            this.utc = this.GetInt(134, 6);
            this.acc = this.GetInt(56, 1);
        ...
        case 19:
            ...
            this.shipname = this.GetStr(143, 120);
            this.cargo = this.GetInt(232, 8);
