...
//			i = parseInt(360/0.5)-1;
			i = parseInt(360/0.25)-1;
		}
		else
		{
//			i = parseInt((lon + 180)/0.5);
			i = parseInt((lon + 180)/0.25);
		}

//		j = parseInt((lat + 90)/0.25); 
		j = parseInt((lat + 90)/0.125); 
		obj.i=i;
		obj.j=j;
		return obj;
	}
...
//		var yIndex=strYindex.slice(strYindex.length-3);
		var xIndex=strXindex.slice(strXindex.length-4);
		var yIndex=strYindex.slice(strYindex.length-4);
